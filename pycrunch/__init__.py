...
each Tuple in a catalog's index, which follows the link to the Entity resource:
    ...
    pycrunch.shoji.Entity(**{u'body': {u'archived': False,
           ...
           u'current_editor': u'https://beta.crunch.io/api/users/00002/',
           ...
           u'notes': u'',
           u'owner': u'https://beta.crunch.io/api/users/00002/',
           ...
           u'specification': u'https://beta.crunch.io/api/specifications/datasets/',
           u'urls': {u'editor_url': u'https://beta.crunch.io/api/users/00002/',
                     u'owner_url': u'https://beta.crunch.io/api/users/00002/',
                     u'user_url': u'https://beta.crunch.io/api/users/00002/'},
